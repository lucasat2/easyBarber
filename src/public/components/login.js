    ...
    <div class="container">
      ...
      <div class="right-side">
        ...
        <div class="login-container">
          ...
          <form id="loginForm">  <!-- Corrigido: Adicionado ID -->
...
form.addEventListener("submit", async (e) => {
    ...
    if (response.ok) {
        ...
        window.location.pathname = "acesso";  // Corrigido: Removido loadPage()
    } else {
