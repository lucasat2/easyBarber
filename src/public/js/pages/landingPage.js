...
aboutDescriptionContainer.appendChild(aboutList)
  ...
  [
    {name:"Otimizar seu Tempo", description: "Organize sua agenda e estimule mais agendamentos através do aplicativo", img: "/assets/landingPage/calendar.png"},
    {name:"Fidelizar seu Cliente", description: "Fidelize através do Agendamento On-line, Programa de Fidelidade, Envio de Promoções e Mensagens de Retorno automáticas.",img: "/assets/landingPage/person.png"},
    {name:"Aumentar seu Faturamento",description:"Aumente seu movimento em até 40% e tenha um maior faturamento em sua barbearia.",img: "/assets/landingPage/money.png"}
  ].forEach((objective) => {
